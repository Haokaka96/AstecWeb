...
namespace Astec.Service
{
    ...
    public class ApplicationRoleService : IApplicationRoleService
    {
        ...
        public ApplicationRoleService(IUnitOfWork unitOfWork, IApplicationRoleRepository appRoleRepository, IApplicationRoleGroupRepository appRoleGroupRepository)
        {
        ...
        {
            if (_appRoleRepository.CheckContains(r => r.Description == appRole.Description))
        ...
        {
            return _appRoleRepository.GetSingleByCondition(s => s.Id == id);
        }
